...
**Bringing a third machine into the fleet:** see [ORCHESTRATION.md](./ORCHESTRATION.md) for extending this pairing to a three-machine setup (this repo's example adds a 6GB GTX 1060 laptop) and wiring all three into Hermes Agent and DeepSeek Harness.
