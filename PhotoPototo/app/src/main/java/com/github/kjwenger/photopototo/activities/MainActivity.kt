package com.github.kjwenger.photopototo.activities
...
import com.github.kjwenger.photopototo.fragments.BrowseFragment
import com.github.kjwenger.photopototo.fragments.RotateFragment
import com.github.kjwenger.photopototo.listeners.FragmentCommunicationListener
import com.github.kjwenger.photopototo.utils.DeviceUtils
// Note: databinding import will be auto-generated after first build
// import com.github.kjwenger.photopototo.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), FragmentCommunicationListener {
    ...
    private fun showManageStoragePermissionDialog() {
        AlertDialog.Builder(this)
            ...
            .setMessage("PhotoPototo needs full storage access to browse all files and folders. This permission allows the app to manage all files on your device.")
            .setPositiveButton(R.string.permission_grant) { _, _ ->
